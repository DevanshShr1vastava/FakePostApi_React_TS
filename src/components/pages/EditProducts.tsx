...
const EditProducts = () => {
  ...
  const productDetails = productData.length > 0 ? productData.find((prod)=>prod.id === Number(id)) : null;
    ...
    <div className = "flex flex-col">
      ...
      <div className="flex w-full justify-center items-center min-h-screen px-4">
        <Form {...form}>
          ...
          >
            <h2 className="text-xl font-semibold text-center text-primary">Edit Product</h2>
